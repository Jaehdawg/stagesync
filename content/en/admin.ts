export const adminCopy = {
  ...
  analyticsPage: {
    ...
    description: 'Funnels, retention, and usage reporting for StageSync operations.',
    recentShowsTitle: 'Recent shows',
    funnelTitle: 'Funnel reporting',
    ...
    metrics: {
      bandShows: 'Bands with shows',
      activeShow: 'Active shows',
