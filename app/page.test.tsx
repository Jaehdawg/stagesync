...
describe('Singer dashboard', () => {
  ...
  it('shows the singer experience and hides band admin controls', async () => {
    ...
    expect(screen.getByRole('link', { name: /^website$/i })).toHaveAttribute('href', 'https://neonecho.example')
    expect(screen.getByRole('link', { name: /^facebook$/i })).toHaveAttribute('href', 'https://facebook.com/neonecho')
